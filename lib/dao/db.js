...
var get = exports.get = function(next) {
    statements().find({}, { 'sort': [['_id','desc']], 'limit': '20' }).toArray(function(err, docs) {
        next(err, docs);
    });
}
...
var all = exports.all = function(conditions, next) {
    statements().find(conditions, { 'sort': [['_id','desc']]}).toArray(function(err, docs) {
        next(err, docs);
    });
}
...
var explain = exports.explain = function(conditions, max, next) {
    statements().find(conditions, { 'sort': [['_id','desc']], 'limit': max }).explain(function(err, docs) {
        next(err, docs);
    });
}
...
var some = exports.some = function(conditions, max, next) {
    statements().find(conditions, { 'sort': [['_id','desc']], 'limit': max }).toArray(function(err, docs) {
        next(err, docs);
    });
}
